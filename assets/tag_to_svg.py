...
# )
# parser.add_argument(
#     'out_img_file', type=str,
#     help='The path to the SVG output file.'
# )
parser.add_argument(
    '--size', type=str, required=False, default='80mm', dest="svg_size",
    help='The size (edge length) of the generated svg such as "80mm" "2in" "20px"'
)
...
def main():
    ...
    tag_file = args.tag_file + ".png"
    out_file = args.tag_file + ".svg"
    out_file_img = args.tag_file + "_larger.png"
    ...
    with Image.open(tag_file, 'r') as im:
        ...
        larger_img = im.resize((600, 600),resample=Image.BOX) # the box part is important
        larger_img.save(out_file_img)
